        ...
        <div className="relative ml-4 w-full">
          ...
          {filtersVisible && (
            <div className="absolute top-full left-0 mt-2 bg-gray-800 border border-gray-700 rounded shadow-lg p-4">
              <div className="mb-2">
                <label className="block text-white" htmlFor="name">Filter by Name:</label>
                <input
                  type="text"
                  name="name"
                  id="name"
              ...
              <div className="mb-2">
                <label className="block text-white" htmlFor="country">Filter by Country:</label>
                <input
                  type="text"
                  name="country"
                  id="country"
              ...
              <div className="mb-2">
                <label className="block text-white" htmlFor="email">Filter by Email:</label>
                <input
                  type="text"
                  name="email"
                  id="email"
              ...
              <div className="mb-2">
                <label className="block text-white" htmlFor="project">Filter by Project:</label>
                <input
                  type="text"
                  name="project"
                  id="project"
              ...
              <div className="mb-2">
                <label className="block text-white" htmlFor="status">Filter by Status:</label>
                <input
                  type="text"
                  name="status"
                  id="status"
